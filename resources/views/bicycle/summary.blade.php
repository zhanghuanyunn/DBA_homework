        ...
        <div class="row m-top-md m-top-lg">
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="statistic-box bg-grey m-bottom-md">
                    ...
                    <div class="m-top-md">Bicycle Today Visit</div>
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="statistic-box bg-dark m-bottom-md">
                    ...
                    <div class="m-top-md">Bicycle Today User</div>
        ...
        <!-- Amcharts -->
            ...
            <script>
                $(document).ready(function(){
                    //getAccessToken();
                    //getUserData();
                    getChartsData('/api/request_records','bicycle');
                    //getData('/api/user').then(response => {console.log(response.data)});
                    postData('/api/request_records_count','bicycle').then(response => {
